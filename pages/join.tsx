...
const pages = () => {
	...
	return (
		<div className="flex items-center justify-center xl:h-screen">
			...
			<div className="relative hidden py-10 pt-24 overflow-x-hidden  h-[820px] rounded-2xl xl:overflow-hidden max-w-7xl lg:flex xl:h-max w-max xl:border xl:shadow-xl xl:border-primary xl:shadow-primary/25">
				...
				<div
					className={`absolute flex rounded-full w-[1500px] transition-all duration-1000 ${
						method === "Login" ? `-left-[90%]` : `left-1/2`
					} ball -top-3/4 xl:-top-[90%] h-[1500px] bg-primary -z-10`}
				></div>
			</div>

			{/* Mobile */}
			<div className="relative flex flex-col w-screen h-screen overflow-hidden lg:hidden">
				<div className="flex justify-center overflow-hidden water-container">
					<div className={`water animation transition-all duration-150`}></div>
					<div className={`water animation transition-all duration-150`}></div>
					<div
						className={`${
				...
				<div className="flex items-center justify-center bg-white h-[720px]">
					<span className="h-[720px]">
						<div
							className={`${
								method === "Login"
									? " opacity-100 top-0"
